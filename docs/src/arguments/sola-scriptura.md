...
|---|---|---|---|---|
| \\(P_{1}\\) | 2 Timothy 3:16 — all scripture is God-breathed and profitable | textual | Reformed Protestant, well supported | 2 Tim 3:16; `calvin-institutes-1960`, §I.vii.1 |
| \\(P_{2}\\) | 2 Timothy 3:17 — that the man of God may be complete, equipped for every good work | textual | Reformed Protestant, well supported | 2 Tim 3:17; `calvin-institutes-1960`, §I.vii.1 |
| \\(P_{3}\\) | Mark 7:8–13 — Jesus rebukes tradition that nullifies God's command | textual | Reformed Protestant, well supported | Mark 7:8-13; `calvin-institutes-1960`, §IV.x.8 |
| \\(P_{4}\\) | Acts 17:11 — the Bereans tested apostolic preaching against scripture | textual | Reformed Protestant, well supported | Acts 17:11; `calvin-institutes-1960`, §I.vii.2 |
...
| \\(P_{6}\\) | Scripture is infallible | theological | Christian, historical-grammatical, consensus | `grudem-systematic-theology-1994`, §ch. 5; `calvin-institutes-1960`, §I.vii |
| \\(P_{7}\\) | Scripture is a sufficient rule of faith | theological | Reformed Protestant, disputed | `grudem-systematic-theology-1994`, §ch. 8; `webster-holy-scripture-2003`; `bavinck-prolegomena-2003`; `calvin-institutes-1960`, §I.vii; `westminster-confession-1647`, §I.6 |
| \\(P_{8}\\) | Scripture is clear on what is necessary for salvation | theological | Reformed Protestant, disputed | `calvin-institutes-1960`, §I.vii.5 |
| \\(P_{9}\\) | Scripture is the sole infallible rule of faith | theological | Reformed Protestant, disputed | `calvin-institutes-1960`, §I.vii–ix |
| \\(P_{10}\\) | Scripture itself teaches that scripture is the sole infallible rule | interpretive | Reformed Protestant, disputed | `calvin-institutes-1960`, §I.vii.4 |
| \\(P_{11}\\) | A doctrine is binding only if scripture teaches it | theological | Reformed Protestant, disputed | `calvin-institutes-1960`, §IV.x.8 |
| \\(P_{12}\\) | No candidate rule of faith other than scripture is infallible | theological | Reformed Protestant, disputed | `westminster-confession-1647`, §I.6; `mathison-shape-sola-scriptura-2001` |
| \\(P_{13}\\) | Tradition is a coordinate source of revelation alongside scripture | theological | Roman Catholic, well supported | `tanner-decrees-1990`, §Trent, Session IV (1546), Decree on Sacred Books and Traditions; `mathison-shape-sola-scriptura-2001` |
| \\(P_{14}\\) | The magisterium is an infallible interpreter of scripture | theological | Roman Catholic, well supported | `tanner-decrees-1990`, §Vatican I (1870), Pastor Aeternus, ch. 4; `mathison-shape-sola-scriptura-2001` |
| \\(P_{15}\\) | The mind of the Church, in the consensus of the Fathers and in received conciliar decisions, infallibly interprets scripture | theological | Eastern Orthodox, well supported | `florovsky-bible-church-tradition-1972`; `ware-orthodox-church-1993` |
| \\(P_{16}\\) | The canon is known through the Church's reception of it | historical | Roman Catholic, consensus | `npnf1-04-1887`, §Augustine, Contra epistolam Manichaei 5.6; `tanner-decrees-1990`, §Trent, Session IV (1546), Decree on Sacred Books and Traditions |
| \\(P_{17}\\) | Identifying the canon requires an infallible authority | theological | Roman Catholic, disputed | `tanner-decrees-1990`, §Trent, Session IV (1546), Decree on Sacred Books and Traditions |
| \\(P_{18}\\) | A rival's own foundational authority is self-authenticating too, so the circularity charge does not discriminate | interpretive | Reformed Protestant, disputed | `kruger-canon-revisited-2012`, §ch. 2 |
| \\(P_{19}\\) | Tradition carries real but fallible — ministerial — authority | theological | Reformed Protestant, disputed | `mathison-shape-sola-scriptura-2001`; `oberman-dawn-1986` |
| \\(P_{20}\\) | Sola scriptura differs in principle from solo scriptura | theological | Reformed Protestant, disputed | `mathison-shape-sola-scriptura-2001`, §ch. 9 |
| \\(P_{21}\\) | The individual retains ultimate interpretive authority, exercised indirectly by choosing which body to submit to | theological | Roman Catholic, disputed | `cross-judisch-interpretive-authority-2009`, §§ III |
| \\(P_{22}\\) | Choosing which authority to submit to is itself private judgement, whichever authority is chosen | interpretive | Reformed Protestant, disputed | `mathison-shape-sola-scriptura-2001`, §ch. 9 |
| \\(P_{23}\\) | The bindingness rule governs first-order doctrine, not a claim about where binding doctrine comes from | theological | Reformed Protestant, disputed | `westminster-confession-1647`, §I.6; `mathison-shape-sola-scriptura-2001` |
| \\(P_{24}\\) | A practice neither commanded nor forbidden in scripture is permitted without scriptural warrant | theological | Reformed Protestant, well supported | `kolb-wengert-book-of-concord-2000`, §Formula of Concord, Solid Declaration X; `westminster-confession-1647`, §I.6 |
| \\(P_{25}\\) | Creeds are informative without being normative | theological | Christian, historical-grammatical, disputed | `geisler-review-mathison-2005`, §120 |
| \\(P_{26}\\) | The historical-grammatical method alone suffices to obtain the meaning of scripture on essential doctrine | interpretive | Christian, historical-grammatical, disputed | `geisler-review-mathison-2005`, §120–121 |
| \\(P_{27}\\) | The creedal consensus is hermeneutically necessary for understanding scripture | interpretive | Reformed Protestant, disputed | `mathison-shape-sola-scriptura-2001`, §275 |
| \\(P_{28}\\) | Doctrine develops without new revelation: the deposit is closed | theological | Christian, historical-grammatical, well supported | `newman-development-1845`; `mathison-shape-sola-scriptura-2001` |
| \\(P_{29}\\) | The creedal consensus rests on the clarity of scripture | interpretive | Reformed Protestant, disputed | `mathison-shape-sola-scriptura-2001`, §279–280 |
| \\(P_{30}\\) | Scripture's clear sense is not obtainable without the creedal consensus | interpretive | Reformed Protestant, disputed | `mathison-shape-sola-scriptura-2001`, §275 |
| \\(P_{31}\\) | Tradition I's reasoning is circular | interpretive | Christian, historical-grammatical, disputed | `geisler-review-mathison-2005`, §122–123 |
| \\(P_{32}\\) | The circularity defeats Tradition I | theological | Christian, historical-grammatical, disputed | `geisler-review-mathison-2005`, §123 |
| \\(P_{33}\\) | Any appeal to an ultimate authority is circular, there being no higher authority to appeal to | theological | Reformed Protestant, disputed | `barrett-gods-word-alone-2016`, §ch. 11 |
| \\(P_{34}\\) | The creedal consensus is established by and accountable to scripture — a product of reading it, not a precondition of it | theological | Reformed Protestant, disputed | `allen-swain-reformed-catholicity-2015`, §ch. 3 |
...
| \\(P_{36}\\) | Perspicuity is claimed only for what is necessary for salvation, not for all of scripture alike | theological | Reformed Protestant, well supported | `westminster-confession-1647`, §I.7 |
