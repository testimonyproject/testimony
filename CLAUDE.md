...
- **Never edit `references.bib`, `docs/src/bibliography.md`,
  `docs/latex/arguments.tex`, or the marked block in `docs/src/roadmap.md`.**
  Generated by `lake exe bibgen`, `lake exe argtex` and `lake exe statusgen`
...
| `Testimony/Tools/` | `Bibgen`, `Argtex`, `Statusgen` — the generators, each with `--check` |
